...
interface IWebsocketRouter {
    ...
    fun routePath(path: String, eventData: JsonObject, user: User): List<IWebsocketNotification>
}

inline fun <reified T: IWebsocketAction> Route.routeWebsocket(path: String, noinline block: IWebsocketRoute<T>.(action: T, user: User) -> IWebsocketNotification?): IWebsocketRoute<T> {
